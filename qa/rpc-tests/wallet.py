...
#   c) node1 mines 32 blocks, so now node 0 has 500000KGS, node 1 has 4250KGS, node2 has none.
#   d) node0 sends 601 KGS to node2, in two transactions (301 KGS, then 300 KGS).
