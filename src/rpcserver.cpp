...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Kingscoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Kingscoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Kingscoin features */
        {"kingscoin", "masternode", &masternode, true, true, false},
        {"kingscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"kingscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"kingscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"kingscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kingscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"kingscoin", "startmasternode", &startmasternode, true, true, false},
        {"kingscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kingscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kingscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"kingscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"kingscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"kingscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"kingscoin", "mnbudget", &mnbudget, true, true, false},
        {"kingscoin", "preparebudget", &preparebudget, true, true, false},
        {"kingscoin", "submitbudget", &submitbudget, true, true, false},
        {"kingscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"kingscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kingscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kingscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kingscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kingscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kingscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kingscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"kingscoin", "mnsync", &mnsync, true, true, false},
        {"kingscoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> kingscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1778/\n";
}
