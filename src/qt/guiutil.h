...
/** Utility functions used by the Kingscoin Qt UI.
 */
namespace GUIUtil
{
...
// Render KGS addresses in monospace font
...
// Parse "kingscoin:" URI into recipient object, return true on successful parsing
