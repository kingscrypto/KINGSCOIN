...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Kingscoin Core kingscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kingscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kingscoin transaction") + "\n" +
                               "  kingscoin-tx [options] -create [commands]   " + _("Create hex-encoded kingscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kingscoin transaction
