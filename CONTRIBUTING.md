Contributing to Kingscoin Core
==================================

The Kingscoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Kingscoin Core project, and is not to be
confused with overall Kingscoin Network Protocol consensus changes.

Whether a pull request is merged into Kingscoin Core rests with the project merge
...
Patches that change Kingscoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Kingscoin consensus, it must have been
...
The project leader is the release manager for each Kingscoin Core release.
