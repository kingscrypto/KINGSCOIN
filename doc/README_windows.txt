...
Intro
-----
Kingscoin (KGS) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Kingscoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run kingscoin-qt.exe.

Kingscoin Core is the original Kingscoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Kingscoin transactions;
